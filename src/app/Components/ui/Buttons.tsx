...
export default function Back_Code_Buttons({ project }: { project: Project }) {
  ...
  return (
    <>
      ...
      <button
        onClick={() => router.push("/")}
        className="absolute left-2 lg:left-8 top-16 lg:top-24 flex items-center justify-center 
      ...
      <a
        ...
        className="absolute right-2 lg:right-8 top-16 lg:top-24 flex items-center justify-center 
                   w-10 h-10 lg:w-12 lg:h-12 rounded-full border border-[#cacaca] text-[#cacaca] 
                   hover:bg-[#cacaca] hover:text-black transition"
